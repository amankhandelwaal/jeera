...
/**
 * Authorization rule that is satisfied only by a PM (project owner) or a system admin, i.e. {@link
 * TransitionContext#canManageIssue()}.
 */
public final class ManageAuthorizationRule implements AuthorizationRule {
  ...
  public ManageAuthorizationRule(
      BiPredicate<IssueStatus, IssueStatus> applicability, String message) {
