...
/**
 * A pre-edge authorization check. Rules are evaluated, in order, before the
 * transition table is consulted — mirroring the original
 * {@code validateActorCanPerformTransition} behaviour where actor checks ran
 * ahead of edge-validity checks.
 */
